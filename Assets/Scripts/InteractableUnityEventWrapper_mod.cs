...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class InteractableUnityEventWrapper_mod : MonoBehaviour
    {
        [SerializeField] KeyPadButton keyPadButton;
        ...
        [SerializeField]
        private UnityEvent<int> _whenSelect;
        ...
        public UnityEvent<int> WhenSelect => _whenSelect;
        ...
        private void HandleStateChanged(InteractableStateChangeArgs args)
        {
            switch (args.NewState)
            {
                ...
                case InteractableState.Select:
                    if (args.PreviousState == InteractableState.Hover)
                    {
                        _whenSelect.Invoke(keyPadButton.keyValue);
                    }
